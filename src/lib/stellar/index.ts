export { horizonServer, sorobanServer, NETWORK_PASSPHRASE, HORIZON_URL, SOROBAN_RPC_URL, STELLAR_EXPLORER_BASE, isSimulationMode, SPLIT_CONTRACT_ID, VAULT_CONTRACT_ID } from "./client";
